...
<div class="wrapper">
    ...
    <form class="p-3 mt-3" action="" method="post" >
        <div class="form-field d-flex align-items-center"> <span class="far fa-user"></span> <input type="text" name="userName" id="userName" placeholder="Username" required></input> </div>
        <div class="form-field d-flex align-items-center"> <span class="fas fa-key"></span> <input type="password" name="password" id="pwd" placeholder="Password" required></input> </div> 
        <button class="btn mt-3" type="submit" name="signup">Sign up</button>
    </form>
    <br>
...
if(isset($_POST['signup'])){
    ...
    $sql = "INSERT into `admins`(`username`,`pass`) values('$_POST[userName]','$hpass' )";
